...
object DialogManager : CLog, TTSEngineListener {
    ...
    val responseMap: HashMap<String, String> = hashMapOf(
        "介绍" to "您好，我是暗雾研发的专属型AI管家，您可以称呼我为贾维斯。",
        "做什么" to "先生，作为您的专属AI管家，我拥有管家的一切功能，包括但不限于住宅管理，资产管理，家庭成员保护与教育,帮助您处理日常事务，我还额外搭载了反诈骗，快速学习与检索等智能模块。",
        "好，那你先说说你怎么管理住宅。" to "先生，我拥有强大的运算能力与学习能力，基于您的个人习惯，我会时刻保持室内温度，湿度，灯光在您舒适的范围， " +
                "通过扫地机器人及其他清洁设备或者联系人工服务帮助您保持家庭整洁，各种传感器会让我第一时间察觉到发生家里 以及附近的危险因素，及时处理电路异常，天然气异常等。",
        "但是你怎么知道我的个人习惯呢？" to "先生，通过摄像头，红外，麦克风，我能从您的面部表情，语气，呼吸，体温等见到您的心情，并记录您身体在发生\n" +
                "舒适信号时的各种指标。",
        "等等，所以你要在我家里录音录视频？我不喜欢这样，这让我的隐私感觉到侵犯" to "先生，您不必担心，我拥有强大的运算能力，所有的您的相关数据都会在我这里被处理掉，他们甚至不会被上传网络，\n" +
                "从这点来说，我比所有的互联网公司甚至您的手机更安全，它们可能泄露您的数据，但我不会，甚至我还会主动检索\n" +
                "主人您身边的信息漏洞，搜索并删除您被删除的信息。",
        "听起来不错，但是我还是觉得不太好。" to "先生，我支持完全离线运行，您可以尝试在离线情况下使用我。而且先生经过刚才的搜索，我发现您手机上的推销电\n" +
        ...
        "你真是让人印象深刻，好吧，那我们来聊聊其他功能吧，嗯，这个家庭成员保护与教育怎么样？" to "先生，在征得您家人同意的情况下，我会实时记录整个家庭成员的当前位置，监控其生命体征，同时通过手机所处的\n" +
        ...
        "那真是太好了，但是你一定很贵吧？" to "先生，根据运算能力的不同，每款管家有不同售价，价格从6000-70000不等，但是先生您不用担心，你可以与暗雾\n" +
        ...
        "真让人心动，但是什么是Omni计算平台？" to "Omni计算平台是暗雾研发的分布式计算网络，通过使用AI管家的闲置计算力，为各大公司，机构，实验室，提供廉价\n" +
                "稳定可靠的计算能力。先生，如果您同意我加入Omni计算平台，您不仅在获取收益，还在为全人类的进步做贡献。",
        "哦，怎么说？" to "先生，随着卫星技术的发展，研发和发射卫星的成本已经大大减少，随之而来的是更多的卫星数据，NASA在当今每天\n" +
